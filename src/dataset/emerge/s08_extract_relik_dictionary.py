...
from dataset.wikipedia.misc.wikipedia_history_dictionary_extractor_v1 import WikipediaHistoryDictionaryExtractorV1
import os
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_file', required=False, type=str,
                        default='experiments/s08_extract_relik_index/20250219/'
                                's08_extract_relik_index.json',
